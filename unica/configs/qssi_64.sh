...
# UN1CA configuration file for Snapdragon devices (qssi/qssi_64)

# Galaxy S24 Ultra (Snapdragon) (One UI 8.5)
SOURCE_FIRMWARE="SM-S928B/EUX/357563650575000"
...
SOURCE_DVFSAPP_CONFIG_DVFS_POLICY_FILENAME="dvfs_policy_sm8650_xx"
SOURCE_DVFSAPP_CONFIG_SSRM_POLICY_FILENAME="siop_e3q_sm8650"
SOURCE_FINGERPRINT_CONFIG_SENSOR="google_touch_display_ultrasonic,settings=4"
...
SOURCE_WLAN_SUPPORT_80211BE=true
